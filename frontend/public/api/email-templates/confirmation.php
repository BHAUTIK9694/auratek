...
/**
 * Auratek Jewels – Confirmation Email Template
 * Sent to the user after they submit the contact/inquiry form.
 *
 * @param array $data  Sanitized form fields: name, email, phone, subject, message
 * @return string      Full HTML email body
 */
function buildConfirmationEmailHtml(array $data): string
{
...
<title>We've Received Your Inquiry — Auratek Jewels</title>
</head>
    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#1a1a1a;border-radius:8px;overflow:hidden;border-top:4px solid #B39260;">
          ...
          <tr>
            <td align="center" style="padding:40px 40px 32px;">
              ...
              <table cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 24px;">
                <tr>
                  <td align="center" style="width:56px;height:56px;background-color:#1e1a13;border:2px solid #B39260;border-radius:50%;">
                    <span style="color:#B39260;font-size:28px;line-height:56px;">&#10003;</span>
                  </td>
                </tr>
              </table>
              <h2 style="color:#fff;font-size:24px;font-weight:700;margin:0 0 12px;">Thank You, $name</h2>
              <p style="color:#aaa;font-size:15px;line-height:1.7;margin:0;">
                We have successfully received your inquiry. Our concierge team at <strong style="color:#B39260;">Auratek Jewels</strong> will review your message and get back to you within <strong style="color:#fff;">24 hours</strong>.
              </p>
            </td>
          </tr>

          <!-- Divider -->
          <tr><td style="padding:0 40px;"><div style="height:1px;background-color:#2a2a2a;"></div></td></tr>

          <!-- Inquiry Summary -->
          <tr>
            <td style="padding:32px 40px;">
              <h3 style="color:#fff;font-size:13px;font-weight:700;letter-spacing:2px;text-transform:uppercase;margin:0 0 20px;">Your Inquiry Summary</h3>

              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td width="110" style="padding:10px 0;color:#888;font-size:13px;vertical-align:top;">Email</td>
                  <td style="padding:10px 0;color:#ddd;font-size:13px;vertical-align:top;">$email</td>
                </tr>
                <tr style="border-top:1px solid #222;">
                  <td width="110" style="padding:10px 0;color:#888;font-size:13px;vertical-align:top;">Phone</td>
                  <td style="padding:10px 0;color:#ddd;font-size:13px;vertical-align:top;">$phone</td>
                </tr>
                <tr style="border-top:1px solid #222;">
                  <td width="110" style="padding:10px 0;color:#888;font-size:13px;vertical-align:top;">Subject</td>
                  <td style="padding:10px 0;color:#ddd;font-size:13px;vertical-align:top;">$subject</td>
                </tr>
                <tr style="border-top:1px solid #222;">
                  <td width="110" style="padding:10px 0;color:#888;font-size:13px;vertical-align:top;">Message</td>
                  <td style="padding:10px 0;color:#ddd;font-size:13px;line-height:1.6;vertical-align:top;">$message</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 40px;">
              <p style="color:#888;font-size:13px;margin:0 0 16px;">In the meantime, feel free to reach us directly:</p>
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="padding:8px 0;">
                    <a href="mailto:auratekjewels@gmail.com" style="color:#B39260;font-size:13px;text-decoration:none;">&#9993; &nbsp;auratekjewels@gmail.com</a>
                  </td>
                </tr>
                <tr>
                  <td style="padding:8px 0;">
                    <a href="https://wa.me/917048104795" style="color:#B39260;font-size:13px;text-decoration:none;">&#128222; &nbsp;+91 70481 04795 (WhatsApp)</a>
                  </td>
                </tr>
                <tr>
                  <td style="padding:8px 0;">
                    <a href="https://www.auratekjewels.com" style="color:#B39260;font-size:13px;text-decoration:none;">&#127760; &nbsp;www.auratekjewels.com</a>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <!-- Footer -->
          <tr>
            <td style="padding:24px 40px;border-top:1px solid #2a2a2a;text-align:center;background-color:#111;">
              ...
              <p style="color:#444;font-size:11px;margin:8px 0 0;">You received this email because you submitted an inquiry on the Auratek Jewels website.</p>
...
/**
 * Plain-text fallback for the user confirmation email.
 */
function buildConfirmationEmailText(array $data): string
{
    $name    = $data['name']    ?? '';
    $email   = $data['email']   ?? '';
    $phone   = $data['phone']   ?? '—';
...
We have successfully received your inquiry at Auratek Jewels.
...
Phone  : +91 70481 04795 (WhatsApp available)
Web    : www.auratekjewels.com

3rd Floor, Office No. 307, Maldeep Apartment, Mahidharpura, Surat, Gujarat 395003, India

Terms & Conditions : www.auratekjewels.com/terms
Privacy & Cookies  : www.auratekjewels.com/privacy
